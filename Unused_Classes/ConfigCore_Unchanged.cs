    ...
    public partial class Config
    {
        ...
        public bool SaveXML()
        {
            ...
            if (File.Exists(_Path))
            {
                ...
                {
                    Globals.Get.ShowMessage("Unable to save settings: " + err.Message);
                    return false;
                }
            }
            ...
            {
                Globals.Get.ShowMessage("Unable to create settings: " + err.Message);
                return false;
            }
    ...
    public class ConfigTimerInfo : ConfigBase
    {
        ...
        public int Duration
        {
            get
            {
                ...
                if (RandomPercent > 0 && Globals.Get.Settings.TypedOptions.GetBool(Config.BoolTypedOptionKeyMap[Config.BoolTypedOption.RandomizeTimers]))
                {
